<div id="viewpayroll" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-class="summary-p-1"="true">
	<div class="modal-dialog modal-fullscreen">
		<div class="modal-content">
			...
			<h4 id="report_title" class="summary-p-1">Payroll list (<?= date("F j Y", strtotime($_GET['start_date'])) . ' - ' . date("F j Y", strtotime($_GET['end_date'])) ?>)</h4>
...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		...
		function generatePDF() {
			...
			printWindow.document.write('<div id="table_2" style = "page-break-before: always;">' + pdfContentHTML + '</div>');
			printWindow.document.write('<div id = "report_signature" style = "bottom: 0 ;">'+report_signature+'</div>');
			...
			// 	printWindow.close();
			// }, 500); // Adjust delay as needed to ensure content is loaded before printing
		}
	});
</script>