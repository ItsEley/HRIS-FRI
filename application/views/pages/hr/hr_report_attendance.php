...
<div class="main-wrapper">
    ...
    <div class="page-wrapper" style="width:-webkit-fill-available;
        ...
        <div class="content container-fluid" data-select2-id="select2-data-23-5b7q">
            ...
            <div class="row legend timeline-panel">
                <div class="col-6">
                    <!-- <h3>Legend</h3> -->
                    <div class="row p-2">
                        <div class="col">
                            
                            <p class = "m-0" ><span class = "att-p">P</span> - Present</p>
                            <p class = "m-0" ><span class = "att-a">A</span> - Absent</p>
                            <p class = "m-0" ><span class = "att-l">L</span> - Late</p>

                        </div>
                        <div class="col">
                        <p class = "m-0" ><span class = "att-d">D</span> - Day-off</p>
                        <p class = "m-0" ><span class = "att-e">E</span> - On Leave</p>
                        <p class = "m-0" ><span class = "att-b">B</span> - On Official Business</p>
