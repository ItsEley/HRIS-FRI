    ...
    <div class="profile-widget">
        ...
        <div class="dropdown profile-action">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <!-- <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_employee"  data-emp-id="<?php echo $emp_id; ?>"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a> -->
            </div>
        </div>
        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="profile.html" style = "text-wrap:nowrap;text-overflow:ellipsis;"><?= $emp_name; ?></a></h4>
